		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#wasteManagementworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wasteManagementworkflowuimodule-display": {
								"semanticObject": "wasteManagementworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wasteManagement.workflowuimodule",
									"url": sap.ui.require.toUrl("wasteManagement/workflowuimodule")
								}
							}
						}
					}
